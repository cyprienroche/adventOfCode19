...
import static CrossingWires.MinimalStepsIntersectionCalculator.*;
import static org.hamcrest.core.Is.is;
import static org.junit.Assert.assertThat;

import org.junit.Test;

public class MinimalStepsCalculatorTest {

  @Test
  public void parallelWiresDoNotHaveMinimalSteps() {
    Wire wire1 = new Wire(new String[]{"R5"});
    Wire wire2 = new Wire(new String[]{"L5"});
    assertThat(minimalCombinedStepsToIntersect(wire1, wire2), is(-1));
  }
  ...
  public void example1() {
    ...
    assertThat(minimalCombinedStepsToIntersect(wire1,wire2), is(30));
  }
  ...
  public void example2() {
    ...
    assertThat(minimalCombinedStepsToIntersect(wire1,wire2), is(610));
  }
  ...
  public void example3() {
    ...
    assertThat(minimalCombinedStepsToIntersect(wire1,wire2), is(410));
  }
}
