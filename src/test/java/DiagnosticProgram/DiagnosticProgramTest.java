...
public class DiagnosticProgramTest {
  ...
  public void storesOneInPosOfThirdParameterIfFirstParameterIsLessThanSecond() {
    ...
    assertThat(new DiagnosticProgram(program1).execute().getProgram(), is(new int[]{1,3,4,0,99}));
    assertThat(new DiagnosticProgram(program2).execute().getProgram(), is(new int[]{0,4,3,0,99}));
  }
